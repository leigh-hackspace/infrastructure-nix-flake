...
//!
//! Supports everything the DigitalOcean API sends us: objects, arrays,
//! strings (with escapes), numbers, booleans and null. Field order is not
//! preserved (we only ever look values up by key).
